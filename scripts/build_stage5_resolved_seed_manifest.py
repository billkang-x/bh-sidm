"""Build a cosmological matrix with a resolved, fixed seed-to-halo ratio."""
...
OUTPUT = ROOT / "hpc" / "stage5_resolved_seed.tsv"
            ...
            rows.append(
                {
                    ...
                    "black_hole_seed_msun": SEED_TO_HALO_RATIO * halo_mass,
